...
%     %TESTING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     g_max_all = [ 300  52.5         55.2  45   2.7   0.054  1890    6000    200    0;   ...       % AB % [S] Conductance values for all (non-leak) channels.
%                  1100  150          22.5  60  4.38  0.219  1576.8  251.85  39.42  0   ]*10^-6;   % PD
...
%                    0  0          22.5  60  4.38  0.219  1576.8  251.85  39.42  0   ]*10^-6;   % PD    
    % Just turn on PD soma conductances and some AB conductances.
%      g_max_all = [ 0  0             0   9     0      0       0       0    0    0; ...       % AB % [S] Conductance values for all (non-leak) channels.
%                    0  0          22.5  60  4.38  0.219  1576.8  251.85  39.42  0   ]*10^-6;   % PD                   
    ...
    %neurons(AB).channels(6).m = 1; %%%%%%%%%% TESTING Starting H high
...
%     current__total
%     figure
%     plot(squeeze(I_sum_hist(neuron, 1, :)))
%     title('Soma current sum history')
%     figure
%     plot(squeeze(I_sum_hist(neuron, 2, :)))
%     title('AIS current sum history')
